...
(function () {
                        ...
                        while (y || z) {
                            ...
                            while (z) {
                                ...
                                if (z.type == 3) {
                                    ...
                                    if (/[^\s\ufeff]/.test(D)) z = null;
                                    C = /[\s\ufeff]$/.test(D);
                                } else if (z.$.offsetWidth > 0 && !z.getAttribute('_cke_bookmark'))
            ...
            createIterator: function () {
                ...
                return {
                    getNextRange: function () {
                        ...
                        if (q && n.length > 1)
                            if (!p)
                                for (var r = n.length - 1; r > 0; r--) o.unshift(n[r].createBookmark(true));
        ...
        j.enterkey = {
            enterBlock: function (s, t, u, v) {
                ...
                if (!D && !E) {
                    ...
                    var H = A.elementPath;
                    if (H)
                        for (var I = 0, J = H.elements.length; I < J; I++) {
                            var K = H.elements[I];
    ...
    (function () {
        ...
        function p(q, r) {
            ...
            q = q.replace(/\b(nbsp|shy|gt|lt|amp)(?:,|$)/g, function (z, A) {
                var B = r ? '&' + A + ';' : u[A],
                    C = r ? u[A] : '&' + A + ';';
                s[B] = C;
                t.push(B);
    ...
    (function () {
        ...
        function q(R) {
            o(R, true);
            if (p(R))
                if (c) R.add(new a.htmlParser.text('\xa0'));
        ...
        function I(R) {
            return R.replace(B, function (S, T, U, V, W) {
        ...
        function J(R) {
            return R.replace(D, function (S) {
                return '<cke:encoded>' + encodeURIComponent(S) + '</cke:encoded>';
            });
        };

        function K(R) {
            return R.replace(E, function (S, T) {
                ...
                exec: function (l) {
                    ...
                    while (r = q.getNextRange()) {
                        ...
                        while (w) {
                            ...
                            if (!(w.getName() == 'img' && w.getAttribute('_cke_realelement')) && o(l, w))
                                if (m.test(w.getName())) w.remove(true);
                                else {
    ...
    (function () {
        ...
        j.add('scayt', {
            ...
            beforeInit: function (s) {
                ...
                t = t.split('|');
                if (t && t.length)
                    for (var v in t) u += 'scayt_' + t[v] + (t.length != parseInt(v, 10) + 1 ? ',' : '');
        ...
        function q(A) {
            if (this.mode == 'wysiwyg') {
                ...
                for (var L = C.length - 1; L >= 0; L--) {
                    ...
                    var M, N;
                    if (F)
                        while ((M = H.getCommonAncestor(false, true)) && (N = f[M.getName()]) && !(N && N[E])) {
        ...
        j.add('wysiwygarea', {
            ...
            init: function (A) {
                ...
                A.on('insertElement', function (J) {
                    var K = J.data;
                    if (K.type == 1 && (K.is('input') || K.is('textarea')))
                        if (!K.isReadOnly()) {
                            K.setAttribute('contentEditable', false);
    ...
    (function () {
        ...
        function o(N, O) {
            ...
            for (var Q = 0, R = P.length; Q < R; Q++) {
                var S = new h(P[Q]);
                if (S.getAttribute('type').toLowerCase() == 'text')
                    if (O) {
        ...
        a.dialog = function (N, O) {
            ...
            if (P.onOk) this.on('ok', function (ae) {
                N.fire('saveSnapshot');
                setTimeout(function () {
                    N.fire('saveSnapshot');
                }, 0);
            ...
            if (P.onCancel) this.on('cancel', function (ae) {
            ...
            this.parts.close.on('click', function (ae) {
                if (this.fire('cancel', {
                        hide: true
            ...
            this.on('iframeAdded', function (ae) {
                ...
                if (N.config.dialog_startupFocusTab && S._.pageCount > 1) {
                    ...
                    if (ai._.editor.mode == 'wysiwyg' && c) {
                        var af = N.document.$.selection,
                            ag = af.createRange();
                        if (ag)
                            if (ag.parentElement && ag.parentElement().ownerDocument == N.document.$ || ag.item && ag.item(0).ownerDocument == N.document.$) {
            ...
            if (b.ie6Compat) this.on('load', function (ae) {
            ...
            this.parts.tabs.on('click', function (ae) {
                var ah = this;
        ...
        a.dialog.prototype = {
            ...
            foreach: function (N) {
                var Q = this;
                for (var O in Q._.contents)
                    for (var P in Q._.contents[O]) N(Q._.contents[O][P]);
                return Q;
            },
            reset: (function () {
                var N = function (O) {
        ...
        function w(N) {
            ...
            N.parts.title.on('mousedown', function (W) {
                N._.updateSize = true;
                O = {
                    x: W.data.$.screenX,
                    y: W.data.$.screenY
        ...
        (function () {
            k.dialog = {
                uiElement: function (N, O, P, Q, R, S, T) {
                    ...
                    var ag = this;
                    N.on('load', function () {
                        if (ag.getInputElement()) ag.getInputElement().on('focus', function () {
        ...
        k.dialog.uiElement.prototype = {
            ...
            setValue: function (N, O) {
                this.getInputElement().setValue(N);
                !O && this.fire('change', {
                    value: N
                });
                return this;
        ...
        (function () {
            ...
            a.on('instanceDestroyed', function (Q) {
    ...
    (function () {
        ...
        function r(P) {
            ...
            if (U)
                for (var W in U) R.removeAttribute(W, U[W]);
            if (T.styles)
                for (var X in T.styles) {
        ...
        function w(P) {
            var Q = /(\S\s*)\n(?:\s|(<span[^>]+_cke_bookmark.*?\/span>))*\n(?!$)/gi,
                R = P.getName(),
                S = x(P.getOuterHtml(), Q, function (U, V, W) {
                    return V + '</pre>' + W + '<pre>';
                }),
                T = [];
        ...
        function x(P, Q, R) {
            var S = '',
                T = '';
            P = P.replace(/(^<span[^>]+_cke_bookmark.*?\/span>)|(<span[^>]+_cke_bookmark.*?\/span>$)/gi, function (U, V, W) {
                V && (S = V);
                W && (T = W);
                return '';
            });
        ...
        function A(P, Q) {
            var R = P._.definition,
                S = e.extend({}, R.attributes, J(P)[Q.getName()]),
                T = R.styles,
        ...
        function F(P, Q) {
            ...
            if (S)
                for (var U in S) P.setAttribute(U, S[U]);
            if (R.styles)
                for (var V in R.styles) {
                    ...
                    e.setTimeout(function () {
                        ...
                        var D = e.bind(function () {
                            ...
                            if (c) {
                                ...
                                if (O.getComputedStyle('direction') == 'rtl')
                                    if (b.ie8Compat) A -= v.getDocument().getDocumentElement().$.scrollLeft * 2;
            ...
            init: function (s) {
                s.on('contentDom', function () {
                    ...
                    if (c) {
                        ...
                        u.on('beforedeactivate', function (C) {
                            if (C.data.$.toElement) return;
                            x = false;
                            y = 1;
                        });
                        if (c && b.version < 8) s.on('blur', function (C) {
                        ...
                        if (c && (b.ie7Compat || b.version < 8 || b.quirks)) v.on('click', function (C) {
                            if (C.data.getTarget().getName() == 'html') s.getSelection().getRanges()[0].select();
                        });
                        var z;
                        u.on('mousedown', function (C) {
                            if (C.data.$.button == 2) {
                        ...
                        function B(C) {
                            if (x) {
                                var D = s.document,
                                    ...
                                    F = E && E.getNative();
                                if (C && F && F.type == 'None')
                                    if (!D.$.queryCommandEnabled('InsertImage')) {
                ...
                return function (t) {
                    ...
                    if (t) {
                        ...
                        for (var w = 0; w < v.length; w++) {
                            ...
                            if (z && z.type == 3)
                                if (B >= z.getLength()) D.setStartAfter(z);
                                else D.setStartBefore(z);
                            if (A && A.type == 3)
                                if (!C) D.setEndBefore(A);
    ...
    (function () {
        ...
        d.range.prototype.select = c ? function (o) {
            var y = this;
            var p = y.collapsed,
                q, r;
            ...
            if (!l) {
                if (this.forceIFrame || this.css.length) {
                    ...
                    r.on('keydown', function (u) {
                        ...
                        if (v == 27 || v == (w == 'rtl' ? 39 : 37))
                            if (x.onEscape && x.onEscape(v) === false) u.data.preventDefault();
                    }, this);
                    l = r.getBody();
                    l.unselectable();
