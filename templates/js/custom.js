...
$(document).on('click','.deleteMsz', function()
{
    var mszId= $(this).attr('data-mszId');
     $.ajax({
            url: SITE_LOC_PATH+'/request/',
            type: 'POST',
            data:{'mszId':mszId,'page':'mszDelete','ajx':1},
            cache: false,
            success: function(data){ 
              // misteryMessage("message Deleted successfully","success");
                 location.reload(); 
    ...
    $(document).on('click', '.replymsz', function(){
       ...
       // alert("hellloo");
        ...
        var username = $(this).attr('data-name'); 
         ...
         var comment = $(this).siblings('#textreply').val();
         //alert(comment);
        $.ajax({
            url: SITE_LOC_PATH+'/request/',
            type: 'POST',
            data:{'ajx':1, 'contactID':contactID, 'page':page, 'userid':userid, 'username':username, 'subject':subject, 'comment':comment},
            success: function(response){
                clickedBtn.removeClass('clicked');

                setTimeout(function () {
                   window.location.href = SITE_LOC_PATH+'/dashboard/message1/';
                    },1000);
                //alert(response);
...
/*...............................................*/
 ...
 // $(document).on('click', '.saveReplymsz', function(){
 ...
 //          //           setTimeout(function () {
 //          //          window.location.href = SITE_LOC_PATH+'/dashboard/message1.php/'
 //          //           },1000);         
 //          // } 
