...
(function () {
    function q(a) {
        ...
        for (var g = !1; a && !d && !g;) {
            try {
                var c = jQuery(a).css("background-color")
            } catch (l) {
                c = "transparent"
            }
...
n.g, n.b]), a = 1, 127 < n && (a = -1), n = Math.round(n + 96 * a), n = {
            r: n,
            g: n,
            b: n
        }) : n = {
    ...
    function m(a, b, d, g) {
        if ("ratio" === b || "%" === b.split("")[b.length - 1]) this.eventTokens[d +
            ...
            return function () {
                ...
                if (c !== e) {
                    ...
                    var f = a.settings;
                    a.jQueryparent.children().remove();
        ...
        }(this.eventTokens, this.jQueryparent, this.jQueryparent.width(),
            1 * this.canvas.width / this.canvas.height))
    }

    function x(a, b, d) {
        var g = this.jQueryparent = jQuery(a);
        a = this.eventTokens = {};
        this.events = new v(this);
        var c = jQuery.fn.jSignature("globalEvents"),
            e = {
                width: "ratio",
                height: "ratio",
                sizeRatio: 4,
        ...
        this.jQuerycontrolbarUpper = jQuery('<div style="padding:0 !important; margin:0 !important;width: 100% !important; height: 0 !important; -ms-touch-action: none; touch-action: none;margin-top:-1em !important; margin-bottom:1em !important;"></div>').appendTo(g);
        this.isCanvasEmulator = !1;
        b = this.canvas = this.initializeCanvas(e);
        d = jQuery(b);
        this.jQuerycontrolbarLower = jQuery('<div style="padding:0 !important; margin:0 !important;width: 100% !important; height: 0 !important; -ms-touch-action: none; touch-action: none;margin-top:-1.5em !important; margin-bottom:1.5em !important; position: relative;"></div>').appendTo(g);
        ...
        e.cssclass && "" != jQuery.trim(e.cssclass) && d.addClass(e.cssclass);
    ...
    function y(a) {
        ...
        if (d) {
            ...
            if (1 !== d) try {
                jQuery(a).children("object").get(0).resize(Math.ceil(a.width * d), Math.ceil(a.height * d)), a.getContext("2d").scale(d, d)
            } catch (g) {}
            return !0
        }
    ...
    var w = function (a, b) {
        ...
        v = function (a) {
            ...
            this.subscribe = function (a, d, g) {
                this.topics[a] ? this.topics[a].push([d, g]) : this.topics[a] = [[d, g]];
                return {
                    topic: a,
                    callback: d
                }
    ...
    x.prototype.resetCanvas = function (a, b) {
        ...
        g.data = a;
        jQuery(d).data("jSignature.data", a).data("jSignature.settings", g);
    ...
    (function (a) {
            ...
            p = {
                ...
                destroy: function () {
                    return this.each(function () {
                        if (!k(this)) {
                            var a =
                                jQuery(this).find("canvas").data("jSignature.this");
                            if (a) {
                                a.jQuerycontrolbarLower.remove();
                                a.jQuerycontrolbarUpper.remove();
                                jQuery(a.canvas).remove();
        ...
        jQuery.fn.jSignature = function (a) {
            if (a && "object" !== typeof a) {
                if ("string" === typeof a && p[a]) return p[a].apply(this, Array.prototype.slice.call(arguments, 1));
                jQuery.error("Method " + String(a) + " does not exist on jQuery.jSignature")
...
(function () {
    ...
    jQuery.fn.jSignature("addPlugin", "instance", "UndoButton", function (k) {
        this.events.subscribe("jSignature.attachingEventHandlers",
            function () {
                if (this.settings[k]) {
                    var h = this.settings[k];
                    "function" !== typeof h && (h = function () {
                        var h = jQuery('<input type="button" value="Undo last stroke" style="position:absolute;display:none;margin:0 !important;top:auto" />').appendTo(this.jQuerycontrolbarLower),
                            k = h.width();
...
(function () {
    ...
    if ("undefined" === typeof jQuery) throw Error("We need jQuery for some of the functionality. jQuery is not detected. Failing to initialize...");
    (function (f) {
        f = f.fn.jSignature;
