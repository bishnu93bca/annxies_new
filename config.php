...
$DOMAIN         = "local.bishnu.com/files";             // For Local Server |  // For Live Server $DOMAIN = "domainname.com"
$SITE_LOC_PATH  = $BASE.$DOMAIN;                        // For Local Server  |  // For Live Server $SITE_LOC_PATH = 'http://www.domainname.com';
$ROOT_PATH      = '/Users/bishnuray/workspace/project_1/files/';    // For Local server  |  // For Live server $ROOT_PATH =$_SERVER['DOCUMENT_ROOT'];    
//------------------------------------------------------------------      
...
$annexisDirDomain     = '/Users/bishnuray/workspace/project_1/files/';
$annexisDirUpld       = 'http://local.bishnu.com/files/';
