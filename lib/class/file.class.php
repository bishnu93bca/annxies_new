...
class FileUpload
{
    ...
    private function createResizeForThumbnail($source_file, $destination_path, $image_name, $dest_width, $dest_height)
    {
    ...
    private function create_resize($source_file, $destination_path, $image_name, $dest_width, $dest_height)
    {
        $destination_file = $destination_path.$image_name;	
        //coping file to destination path ------------------START
        copy($source_file,$destination_file);
    ...
    public function uploadImage($source, $targetLocation, $fileName, $TWH, $LWH, $option='all') // $option = upload, thumbnail, resize, all
    {              
        if(is_array($source)){
