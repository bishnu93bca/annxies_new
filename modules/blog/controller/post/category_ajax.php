			...
			<div class="<?php echo $class;?> border">
                ...
                if($cData[$row]['attributeType']=='radio' || $cData[$row]['attributeType']=='checkbox')
                {
                    ...
                    foreach($options as $val)
                    {
                        ...
                        <input type="<?php echo $cData[$row]['attributeType'];?>" name="attributeValueArray_<?php echo $row;?>[]" value="<?php echo $val;?>" <?php if($editid && in_array_r($val, $attributeData)) echo 'checked';?> /><?php echo $val;?> 
                        </li>
                        <?php
                    }
                    echo '</ul>';
                ...
                else
                {
                    ...
                    <input type="text" value="<?php echo $attributeData[$arrayKey]['attributeValue'];?>" name="attributeValueArray_<?php echo $row;?>[]" style="width:150px;" /></p>
                    <?php
                }
                ?>
