            ...
            foreach($fetch_Details as $pData)
			{
                ...
                <li id="recordsArray_<?php echo $pData['contactID'];?>">
                    ...
                    <span class="u_name" style="width:15%">
                        <a title="<?php echo $pData['product'];?>" href="index.php?pageType=<?php echo $pageType;?>&dtls=<?php echo $dtls;?>&dtaction=add&editid=<?php echo $editid;?>&contactID=<?php echo $pData['contactID'];?>&page=<?php echo $page; ?>&parentId=<?php echo $parentId;?>&moduleId=<?php echo $moduleId;?>&type=<?php echo $type;?>">
                            <?php 
                            if($pData['product']){
