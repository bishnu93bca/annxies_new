...
<div class="table">
	<ul class="table_head">
        ...
        <li class="u_name" style="width:15%">Description</li>
    ...
    <ul class="table_elem">
        ...
        if($countRow)
        {
            ...
            ***************************************************************/
			...
			{
				if($pData['isApproved'] == 'Sample Received')
				{
                ...
                <li id="recordsArray_<?php echo $pData['sampleId'];?>">
                    ...
                    <span class="u_name" style="width:15%">
                        <a title="<?php echo $pData['description'];?>" href="index.php?pageType=<?php echo $pageType;?>&dtls=<?php echo $dtls;?>&dtaction=add&editid=<?php echo $pData['sampleId'];?>&id=<?php echo $pData['sampleId'];?>&page=<?php echo $page; ?>&parentId=<?php echo $parentId;?>&moduleId=<?php echo $moduleId;?>&type=<?php echo $type;?>">
                            <?php 
                    ...
                    <span class="t_days" style="width:10%"> <?php echo $pData['isApproved'];?></span>
                    <span class="t_days" style="width:10%"> <?php echo $pData['sampleReqId'];?></span>
                    <span class="last_li">
                        
                        
                        <a href="index.php?pageType=<?php echo $pageType;?>&dtls=<?php echo $dtls;?>&dtaction=add&editid=<?php echo $pData['sampleId'];?>&sampleId=<?php echo $pData['sampleId'];?>&page=<?php echo $page; ?>&parentId=<?php echo $parentId;?>&moduleId=<?php echo $moduleId;?>&type=<?php echo $type;?>" title="edit"><img src="images/view.png" alt="" width="16" height="16" border="0" /></a>
                        <?php /*                         
