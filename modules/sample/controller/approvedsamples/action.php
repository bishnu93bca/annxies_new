...
if(isset($Save) && $SourceForm == 'SendSample')
{
    ...
    if($qty !='' && $unitType !='' && $price !='' && $currency !='' && $sendStatus !='')
    {
        ...
        {   
            ...
            {            
                ...
                $other  = 'You have approved sample request id - '.$requestId;
                ...
                $sother  = 'Admin has approved your sample request having request id - '.$requestId;
