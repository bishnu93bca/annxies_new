	...
	if($cData)
	{
		...
		for($row=0; $row<sizeof($cData); $row++)
		{
			...
			<div class="<?php echo $class;?>">
                ...
                {
                	if($productId)
                        $attributeData = $obj->getReqAttributeByproductId("attributeId='".$cData[$row]['attributeId']."'", $productId, 0, 50);
                ...
                {
                	if($productId)
                        $attributeData = $obj->getReqAttributeByproductId(1, $productId, 0, 50);
