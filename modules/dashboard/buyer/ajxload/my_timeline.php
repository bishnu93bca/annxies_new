<?php
$ExtraQryStr = 1;
$pData       = $eObj->myTimeline($_SESSION['FUSERID'], $ExtraQryStr, 0, 30);
?>
        ...
        foreach($pData as $record){
            ...
            <div class="question_block <?php echo ($sl==0 && $record['commentCount']>0)? 'opened':'';?>">
                <div class="question_head">
                    ...
                    <h5 class="qthead"><?php echo $_SESSION['FUSERFULLNAME'];?></h5>
                                ...
                                <div class="qrp_block clearfix">
                                    ...
                                    <div class="qrp_right">
                                        <div class="qrtop">
                                            ...
                                            <div class="post_mstream"><?php echo $rd['post'];?></div>
                                                ...
                                                <div class="qcreply clearfix">
                                                    ...
                                                    <div class="qcr_right">
                                                        <div class="qrtop">
                                                            ...
                                                            <div class="post_mstream"><?php echo $rc['post'];?></div>
