            ...
            <div class="fav_details myProfile "> <!--otherProfile-->
                    ...
                    <div class="profile_right parent">
                        ...
                        <div class="profile_post">
                            ...
                            <div class="friend_btm">
                                ...
                                <a href="<?php echo $publicUrl;?>" class="btn btn_small btn_action frnd_comment"><i class="fa fa-comments"></i>  Message</a>
                            </div>
                                                                ...
                                                                <div class="qrtop">
                                                                    <h5 class="qthead">
                                                                        ...
                                                                        ?>
                                                                         ...
                                                                         <span class="grey">(Rutherford University)</span>
                                                                    </h5>
                ...
                <div class="friend_info">
                    ...
                    <div class="fdetails clearfix">
                        ...
                        <div class="fd_loc">
                            <div class="pc_loc">
                                <img src="<?php echo $STYLE_FILES_SRC;?>/images/pc_loc.png" alt="">
                                <span>Hindu College, New Delhi</span>
                            </div>
                        </div>
                    </div>
                </div>
