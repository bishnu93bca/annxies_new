...
$ExtraQryStr = "usertype='Buyer'";

if ($srchtxt)
	$_SESSION['srchtxt'] = $srchtxt;
if($_SESSION['srchtxt'])
	$ExtraQryStr .= " and (username='".addslashes($_SESSION['srchtxt'])."' or  name='".addslashes($_SESSION['srchtxt'])."' or  surname='".addslashes($_SESSION['srchtxt'])."' or email='".addslashes($_SESSION['srchtxt'])."')";
...
$countRow = $cObj->memberCount($ExtraQryStr);
?>
<ul id="breadcrumb">
		...
		<ul class="table_customer">
            ...
            if($countRow)
            {
                ...
                ***************************************************************/
                ...
                $fetch_Details = $cObj -> getMemberDetails($ExtraQryStr, $start, $limit);
