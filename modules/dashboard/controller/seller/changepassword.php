...
if($recruiterId){
	$cData    		= $cObj->getMemberInfoByid($recruiterId);
	include("intro.php");
}
?>
<br class="clear">
<form name="modifycontent" action="" method="post">
    <div class="form_holder"> 
    	<div style="    border-right: #e8e8e8 1px solid;    float: left;     width: 45%;     padding-right: 25px;">  
    ...
    <input name="SourceForm" type="hidden" value="MemberPassword" />
