    ...
    if(sizeof($fetch_details)>0)
    {
        ...
        for($row=0;$row<sizeof($fetch_details);$row++)
        {
            ...
            <li>
                ...
                <a href="index.php?pageType=<?php echo $pageType;?>&dtls=<?php echo $dtls;?>&dtaction=status&stschgto=<?php echo $status?>&id=<?php echo $fetch_details[$row]['contentID'];?>&moduleId=<?php echo $moduleId; ?>&action=content&redstr=<?php echo $redirectString;?>" title="status" class="ask"><?php echo $conStatus;?></a>
