...
if($contactID!='')
{
    ...
    $scountry      = $cObj->stateBycode($scountry);
}
$menu=new menu();
                ...
                <div class="form_holder">
                    ...
                    <fieldset><legend>Sample Request</legend>                        
                        ...
                        <div class="" style="width:20%;float:left; margin-right:10px;">
                            ...
                            <p class="description-line1">
                                <input name="qty" type="text" value="<?php echo $qty;?>" size="30" maxlength="100" />
                            </p>     
                        </div>
                        <div class="" style="width:20%;float:left; margin-right:10px;">
                            <p class="description-line1">Unit </p>
                            <p class="description-line1">
                                <input name="unitType" type="text" value="<?php echo $unitType;?>" size="30" maxlength="100" />
                            </p>
                        </div>
                        <div class="" style="width:20%;float:left; margin-right:10px;">
                            <p class="description-line1">Order Value</p>
                            <p class="description-line1">
                                <input name="price" type="text" value="<?php echo $price;?>" size="30" maxlength="100" />
                            </p>     
                        </div>
